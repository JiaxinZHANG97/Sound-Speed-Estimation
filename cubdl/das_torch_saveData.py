# File:       das_torch_saveData.py
# Author:     Dongwoon Hyun (dongwoon.hyun@stanford.edu)
# Created on: 2020-03-09
# Modified on: 2024-04-07 (Jiaxin Zhang jzhan295@jhu.edu)
import torch
...
class DAS_PW_saveData(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return idas, qdas, txapo, rxapo, txdel, rxdel
