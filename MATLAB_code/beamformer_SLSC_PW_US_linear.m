...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [slsc,cc,metadata,x_axis,z_axis] = beamformer_SLSC_PW_US_linear(delay_data,metadata)
...
cc = zeros(size(delay_data,1),maxM,size(delay_data,3),metadata.Sys.N_pw);
