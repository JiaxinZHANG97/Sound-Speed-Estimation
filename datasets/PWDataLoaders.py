...
def load_data(data_source, acq):
    ...
    datadir2 = "2_Post_CUBDL_JHU_Breast_Data"
    ...
    if data_source == "MYO":
        ...
        if acq in list(range(24, 35)):
            database_path = os.path.join("datasets", datadir2)
        else:
            raise ValueError("JHU%03d is not a valid plane wave acquistion." % acq)
